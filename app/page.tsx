...
import { BookUser, BrainCircuit, CalendarDays, Link as LinkIcon, Users, ArrowRight } from "lucide-react";
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-slate-900 leading-tight">
          Smart & Effortless Scheduling
        </h1>
        <p className="mt-6 text-base sm:text-lg md:text-xl text-slate-600 max-w-2xl mx-auto">
          Meeteazy simplifies scheduling with your personal booking page, smart assistance, and automated confirmations. Focus on your meetings, not the setup.
        </p>
